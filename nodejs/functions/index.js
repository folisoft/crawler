...
// exports.scheduledFunctionCrontab = functions.pubsub.schedule('6 0 * * *') //Apply Blazer pakage => Need money
//     .timeZone('America/Asia/Ho_Chi_Minh') // Users can choose timezone - default is America/Los_Angeles
//     .onRun(async (context) => {
//         await crawler();
//         return null;
//     });
...
async function crawler() {
    ...
    await axios.post('https://oco.vn/api/update-quantity', JSON.stringify(products))
    await browser.close();
}
